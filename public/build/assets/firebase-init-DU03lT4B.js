import{i as p,g as u,o as m,a as b}from"./index.esm2017-NZQW5Whv.js";let l=null,s=null,c=!1;document.addEventListener("DOMContentLoaded",()=>{if(l)return;console.log("Инициализация Firebase..."),l=p({apiKey:"AIzaSyB6N1n8dW95YGMMuTsZMRnJY1En7lK2s2M",authDomain:"dlk-diz.firebaseapp.com",projectId:"dlk-diz",storageBucket:"dlk-diz.firebasestorage.app",messagingSenderId:"209164982906",appId:"1:209164982906:web:0836fbb02e7effd80679c3"}),s=u(l),g(),h()});function g(){s&&m(s,e=>{var t,o,i,n,a,d;console.log("Получено сообщение в активном окне:",e),v(((t=e.notification)==null?void 0:t.title)||"Новое сообщение",((o=e.notification)==null?void 0:o.body)||"",e.data),x(((i=e.notification)==null?void 0:i.title)||"Новое сообщение",((n=e.notification)==null?void 0:n.body)||"",(a=e.data)==null?void 0:a.chatId,(d=e.data)==null?void 0:d.chatType)})}function h(){if(!("Notification"in window)){console.log("Этот браузер не поддерживает уведомления");return}const e=Notification.permission;console.log("Текущее разрешение для уведомлений:",e),e==="granted"?f():e!=="denied"&&w()}function w(){if(document.querySelector(".notification-permission-banner"))return;const e=document.createElement("div");e.className="notification-permission-banner",e.innerHTML=`
